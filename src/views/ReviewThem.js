...
export default function ReviewThem() {
    ...
    return (
        <div style={{ backgroundColor: 'rgba(240, 244, 253, 1)', position: 'relative', height: '810px' }}>
            ...
            <p style={{ fontFamily: 'Tahoma', fontSize: '14px', textAlign: 'center', color: 'rgba(56, 79, 125, 1)', position: 'relative', display: 'inline-block', left: '0%', right: '0%', top: '55%' }}>Rate and write reviews of the books you have read so that other users can be impressed</p>
