            ...
            <>
                <div style={{position:'relative'}}>
                    ...
                    <div style={{position:'absolute', top:'100px', left:'0', right:'0'}}>
                        <button style={{position:'absolute', left:'0', right:'0', top:'80px', display: 'block', justifyContent: 'center', alignItems: 'center', margin: 'auto', backgroundColor: 'rgba(186, 251, 103, 1)', color: 'black', textAlign: 'center', fontSize: '25px', border:'1px solid #8C6630', borderRadius:'10px'}}><DeleteIcon/></button>
                        <Book></Book>
                    </div>
                </div>
                <Menu/>
